...
public class AlreadyScheduledException extends SchedulingException {
	...
	public AlreadyScheduledException(String msg) {
		this(msg, null);
	}
	
	public AlreadyScheduledException(Throwable cause) {
		this(null, cause);
	}
	
	public AlreadyScheduledException(String msg, Throwable cause) {
		super(msg, cause);
	}
}
